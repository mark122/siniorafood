<template>
    <app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style="margin-top:30px;text-align: center!important;float: center!important;">
            <div class="flex flex-col items-center">
                <div class="w-full sm:w-2/3">
                    <div class="flex">
                        <div class="relative inline-flex">
                            <h4 class="py-4 px-4 text-xl font-semibold leading-tight text-gray-800 mb-4">Incomplete Assessments</h4>
                        </div>
                    </div>
                        ...
                        <empty-student-card :title="'No Sessions Found'">
                            <template #action>
                                <inertia-link :href="route('quiz_dashboard')">
                                    <span class="qt-btn qt-btn-sm qt-btn-primary">View Assessments</span>
                                </inertia-link>
                            </template>
                        </empty-student-card>
                    </div>
