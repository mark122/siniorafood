        ...
        <div class="container mx-auto pt-4 px-4 sm:px-6 lg:px-8">
            <div class="w-full bg-white dark:bg-gray-800 py-5 flex flex-col xl:flex-row items-start xl:items-center justify-between px-5 xl:px-10 shadow rounded-t">
                <div class="mb-4 sm:mb-0 md:mb-0 lg:mb-0 xl:mb-0 lg:w-1/2">
                    ...
                    <p class="font-normal text-sm text-gray-600 dark:text-gray-100 mt-1" v-html="editFlag ? quiz.title : 'New Assessment'"></p>
                </div>
                            ...
                            <div class="bg-gray-100 rounded p-6">
                                ...
                                <div v-else>
                                    <div class="text-sm mb-4 flex justify-between items-center">
                                        ...
                                        <button v-if="qEditFlag == true && quiz.quiz_type_id == 1" type="button" @click="addAllQuestion" class="qt-btn qt-btn-success">Add All</button>
                                        <button v-if="qEditFlag == false && quiz.quiz_type_id == 1" type="button" @click="removeAllQuestion" class="qt-btn qt-btn-success">Remove All</button>
                                        ...
                                        <template v-for="(question, index) in questions">
                                            <template v-if="question.question_type === 'MSA'">
                                                <MSAPreview :question="question">
                                                    <template #action>
                                                        <button v-if="quiz.quiz_type_id != 1" class="qt-btn-sm" @click="qEditFlag ? addQuestion(question.id, index) : removeQuestion(question.id, index)" v-html="qEditFlag ? 'Add' : 'Remove'"
        ...
        methods: {
            ...
            fetchQuestions() {
                ...
                .then(function (response) {
                    ...
                    _this.addDifficultyFilter = _this.difficultyFilter;
                    _this.addTypeFilter = _this.typeFilter;
                    _this.addSkillFilter = _this.skillFilter;
                    _this.addSectionFilter = _this.sectionFilter;
                    _this.addTopicFilter = _thistopicFilter;
                    _this.addCodeFilter =  _this.codeFilter;
            ...
            addAllQuestion() {
                ...
                this.$confirm.require({
                    header: 'Confirm',
                    message: 'Do you want to add all question?',
                    ...
                    accept: () => {
                        ...
                        axios.get(route('quizzes.add_all_filtered_available_questions', {
                            quiz: this.quiz.id,
                            difficulty_levels: _this.addDifficultyFilter,
                            question_types: _this.addTypeFilter,
                            section: _this.addSectionFilter,
                            skill: _this.addSkillFilter,
                            topic: _this.addTopicFilter,
                            code: _this.addCodeFilter
                        })).then(function (response) {
                            _this.$toast.add({
                                severity: 'success',
                                summary: 'Added',
            ...
            removeAllQuestion() {
                ...
                this.$confirm.require({
                    header: 'Confirm',
                    message: 'Do you want to remove all questions?',
                    icon: 'pi pi-info-circle',
                    acceptClass: 'p-button-danger',
                    rejectLabel: 'Cancel',
                    acceptLabel: 'Remove',
                    accept: () => {
                        _this.processing = true;
                        axios.post(route('quizzes.remove_all_question', {quiz: this.quiz.id}))
                            .then(function (response) {
                                _this.$toast.add({
                                    severity: 'info',
                                    summary: 'Removed',
