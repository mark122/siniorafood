        ...
        <div class="container mx-auto pt-4 px-4 sm:px-6 lg:px-8">
            <div class="w-full bg-white dark:bg-gray-800 py-5 flex flex-col xl:flex-row items-start xl:items-center justify-between px-5 xl:px-10 shadow rounded-t">
                <div class="mb-4 sm:mb-0 md:mb-0 lg:mb-0 xl:mb-0 lg:w-1/2">
                    <h2 class="text-gray-800 dark:text-gray-100 text-lg font-bold">Practice Set Questions</h2>
                    <p class="font-normal text-sm text-gray-600 dark:text-gray-100 mt-1" v-html="editFlag ? practiceSet.title : 'New Assessment'"></p>
                </div>
                            ...
                            <div>
                                ...
                                <div class="w-full flex flex-col mt-6">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <div class="p-field-radiobutton" v-for="questionType in questionTypes">
                                ...
                                <div v-else>
                                    ...
                                    <div class="grid grid-cols-1 gap-4 flex-wrap">
                                        ...
                                        <div v-if="questions.length === 0" class="flex justify-center items-center">
                                            <h4 class="text-sm p-4 font-semibold">No Questions</h4>
                                        </div>
                                        <div v-else-if="pagination && !(questions.length === pagination.total)" class="flex justify-center items-center">
                                            <button @click="loadMoreQuestions" class="qt-btn-success">Load More</button>
                                        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            title() {
                return this.practiceSet.title+ ' (Questions) - ' + this.$page.props.general.app_name + ' Admin';
            }
        },
        methods: {
            viewQuestions() {
            ...
            fetchQuestions() {
                ...
                _this.loading = true;
                this.questions = [];
                axios.get(route('practice-sets.fetch_questions', {
            ...
            fetchAvailableQuestions() {
                ...
                _this.loading = true;
                this.questions = [];
                axios.get(route('practice-sets.fetch_available_questions', {
                    practice_set: this.practiceSet.id,
                    difficulty_levels: this.difficultyFilter,
                    question_types: this.typeFilter,
                    code: this.codeFilter,
            ...
            addQuestion(questionId, index) {
                ...
                axios.post(route('practice-sets.add_question', {practice_set: this.practiceSet.id}), { question_id: questionId })
                    .then(function (response) {
            ...
            removeQuestion(questionId, index) {
                ...
                this.$confirm.require({
                    ...
                    acceptLabel: 'Remove',
                    accept: () => {
                        axios.post(route('practice-sets.remove_question', {practice_set: this.practiceSet.id}), { question_id: questionId })
                            .then(function (response) {
                                _this.questions[index].disabled = true;
                                _this.$toast.add({
                                    severity: 'info',
