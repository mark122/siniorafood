                    ...
                    <vue-good-table mode="remote" @on-page-change="onPageChange" @on-column-filter="onColumnFilter" @on-per-page-change="onPerPageChange"
                        ...
                        <template slot="table-row" slot-scope="props">
                            ...
                            <div v-else-if="props.column.field === 'actions'">
                                ...
                                <Button v-if="current_user_role === 'admin'" icon="pi pi-file-o" class="p-button-rounded p-button-danger p-button-text" @click="ViewDocument(props.row.id)"/>
                            </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                editForm: false,
                currentId: null,
                current_user_role: this.$page.props.user.role_id,
                columns: [
                    {
                        label: 'Name',
                        field: 'fullName',
        ...
        methods: {
            ...
            ViewDocument(id) {
                this.$inertia.get(route('user-documents-list', {id: id}))
            },
            deleteUser(id) {
