...
use App\Http\Controllers\Admin\UserDocumentCrudController;
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('admin')->group(function () {
    ...
    */
    ...
    Route::resource('userdocuments', UserDocumentCrudController::class);
    Route::get('user-documents/{id}/list', [UserDocumentCrudController::class, 'index'])->name('user-documents-list');
    ...
    */
    ...
    Route::get('quizzes/{quiz}/graph-overall-report', [QuizAnalyticsController::class, 'graphoverallReport'])->name('graph_quizzes.overall_report');

    Route::get('quizzes/{quiz}/graph-overall-report/{slug}', [QuizAnalyticsController::class, 'graphoverallReport'])->name('graph_quizzes.overall_report_slug');

    Route::get('quizzes/{quiz}/graph-detailed-report', [QuizAnalyticsController::class, 'graphdetailedReport'])->name('graph_quizzes.detailed_report');

    Route::get('quizzes/{quiz}/graph-detailed-report/{slug}', [QuizAnalyticsController::class, 'graphdetailedReport'])->name('graph_quizzes.detailed_report_slug');

    Route::get('quizzes/{quiz}/graph-skill-detailed-report/{slug}/{skill}/', [QuizAnalyticsController::class, 'graphSkillReport'])->name('graph_skill_detailed_report');
    
    Route::get('quizzes/{quiz}/graph-skill-overall-report/{slug}/{skill}/', [QuizAnalyticsController::class, 'graphSkillOverallReport'])->name('graph_skill_overall_report');

    Route::get('graph-report/{slug}', [QuizAnalyticsController::class, 'graphReport'])->name('graph-report');
    Route::get('graph-report', [QuizAnalyticsController::class, 'graphReport']);
    ...
    Route::get('/quizzes/{quiz}/add-all-filtered-available-questions', [QuizQuestionController::class, 'AddAllFilteredAvailableQuestions'])->name('quizzes.add_all_filtered_available_questions');
    ...
    Route::post('/quizzes/{quiz}/remove-all-question', [QuizQuestionController::class, 'removeAllQuestion'])->name('quizzes.remove_all_question');
